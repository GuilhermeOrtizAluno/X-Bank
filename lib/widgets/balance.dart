...
class _BalanceState extends State<Balance> {
              ...
              Column(
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Text(
                        current ?  "${(model.userData["currentBalance"].toStringAsFixed(2).replaceAll(".", ","))} R\$" : "****" ,
                        style: Theme.of(context).textTheme.bodyText1,
                      ),
                      Padding(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Text(
                        savings ? "${model.userData["savingsBalance"].toStringAsFixed(2).replaceAll(".", ",")} R\$" : "****" ,
                        style: Theme.of(context).textTheme.bodyText1,
                      )
                    ],
                  )
  ...
  Widget _converter(model){
    return Text(
      savings ? "${model.userData["savingsBalance"].toStringAsFixed(2)} R\$" : "****" ,
      style: Theme.of(context).textTheme.bodyText1,
    );
  }
